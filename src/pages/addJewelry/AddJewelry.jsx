...
const AddJewelry = () => {
  ...
  return (
    <div className="py-32">
      <h1 className="text-center font-bold text-2xl text-[#832729]">
        Add New Products
      </h1>
      <img src={line} alt="" />
      <div>
        <form
          ...
          className="shadow-xl p-5 rounded-md md:w-8/12 mx-auto"
        >
            ...
            <div className="w-full md:mr-10">
              ...
              <div className="mb-4">
                ...
                >
                  ...
                  <option value={CategoryEnum.Necklaces}>
                    {CategoryEnum.Necklaces}
                  </option>
                  <option value={CategoryEnum.Rings}>
                    {CategoryEnum.Rings}
                  </option>
                  <option value={CategoryEnum.Bracelets}>
                    {CategoryEnum.Bracelets}
                  </option>
                  <option value={CategoryEnum.Chain}>
                    {CategoryEnum.Chain}
                  </option>
                  <option value={CategoryEnum.NosePins}>
                    {CategoryEnum.NosePins}
                  </option>
                  <option value={CategoryEnum.Earrings}>
                    {CategoryEnum.Earrings}
                  </option>
                  <option value={CategoryEnum.Anklets}>
                    {CategoryEnum.Anklets}
                  </option>
                  <option value={CategoryEnum.Brooches}>
                    {CategoryEnum.Brooches}
                  </option>
                  <option value={CategoryEnum.Watches}>
